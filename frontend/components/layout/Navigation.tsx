              ...
              <>
                <Link href="/saved">
                  <Button
                    variant="outline"
                    size="sm"
                    className="bg-blue-50 text-blue-700 border-blue-200 hover:bg-blue-100 text-xs sm:text-sm px-2 sm:px-3"
                  >
                ...
                <Button
                  ...
                  className="flex items-center gap-1 sm:gap-2 bg-white border-gray-200 hover:bg-gray-50 p-1 sm:p-2"
                >
